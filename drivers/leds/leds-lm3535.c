...
extern unsigned get_tpo_defvalue (void);
...
static long als_z0_interim_zeppelin[] = {12, 1413, 748270, 683326845};
static long als_z0[] =          {-48, 22225, -616209, 587754883};
static long als_z0_motus[] =    {-48, 22225, -616209, 587754883};
static long als_z0_zeppelin[] = {0, 2000, 1483000, 637300000};
#else // Calgary
...
static long als_z1_interim_zeppelin[] = {30, -17826, 4625368, 715865068};
static long als_z1[] =          {24, -14596, 3987380, 659307205};
static long als_z1_motus[] =    {24, -14596, 3987380, 659307205};
static long als_z1_zeppelin[] = {0, -6500, 3677400, 687018600};
#else // Calgary
...
static long als_z2_interim_zeppelin[] = {28, -17354, 3624873, 994604769};
static long als_z2[] =          {0, -5700, 2553000, 953424200};
static long als_z2_motus[] =    {0, -5700, 2553000, 953424200};
static long als_z2_zeppelin[] = {0, -5700, 2553000, 953424200};
#else // Calgary
static long als_z2[] =  {0, -5700, 2553000, 953424200};
#endif
...
static long als_z3_interim_zeppelin[] = {28, -17354, 3624873, 994604769}; 
static long als_z3[] =          {0, -5700, 2553000, 953424200};
static long als_z3_motus[] =    {0, -5700, 2553000, 953424200};
static long als_z3_zeppelin[] = {0, -5700, 2553000, 953424200};
#else // Calgary
static long als_z3[] =  {0, -5700, 2553000, 953424200};
#endif
...
static long als_z4_interim_zeppelin[] = {28, -17354, 3624873, 994604769};
static long als_z4[] =          {0, -5700, 2553000, 953424200};
static long als_z4_motus[] =    {0, -5700, 2553000, 953424200};
static long als_z4_zeppelin[] = {0, -5700, 2553000, 953424200};
#else // Calgary
    ...
    const struct i2c_device_id *id)
{
    ...
    unsigned tpo_display_defvalue = get_tpo_defvalue();
#else
    ...
    if (machine_is_morrison ()) {
        ...
        if (display_id == tpo_display_defvalue) {
            printk (KERN_INFO "%s: interim display\n", __FUNCTION__);
            memcpy (als_z0, als_z0_interim_zeppelin, sizeof (als_z0));
            memcpy (als_z1, als_z1_interim_zeppelin, sizeof (als_z1));
            memcpy (als_z2, als_z2_interim_zeppelin, sizeof (als_z2));
            memcpy (als_z3, als_z3_interim_zeppelin, sizeof (als_z3));
            memcpy (als_z4, als_z4_interim_zeppelin, sizeof (als_z4));
        } else {
...
#ifdef CONFIG_MACH_MOT
    printk (KERN_INFO "%s: display id = 0x%x\n", __FUNCTION__, display_id);
#endif
