...
{
	/* Dummy variable for the second argument in the meta_proc api */
	unsigned dummy = 0 ;
...
static PU_MAIN_POWERUP_REASON_TYPE get_modem_powerup_reason(void)
{
	...
	smem_appsbl_interface = smem_alloc(SMEM_APPS_BOOT_MODE,
...
static struct proc_dir_entry *proc_powerup_info;
